...
navbarPage(id='tesis' ,title = "Tesis",
           ...
           tabPanel('Introducción',icon=icon('home'),
                    ...
                    fluidRow(
                      ...
                      sidebarPanel(img(src='epn_logo2.png',width='90%',align='center' ),
                                   ...
                                   hr(),
                                   fluidRow(
                                     column(3,tags$b('Proyecto Titulación:')),column(1),
                                     column(8,'Análisis Clúster para series de tiempo estacionales y modelización de caudales de ríos del Brasil.')
                                   ),hr(),
                                   fluidRow(
                                     column(3,tags$b('Proyecto Semilla:')),column(1),
                                     column(8,'PIS-16-14')
                                   ),hr(),
                                   fluidRow(
                                   ...
                                   fluidRow(
                                     column(3,tags$b('Autor:')),column(1),
                      ...
                      mainPanel(
                        h3('Análisis Clúster para series de tiempo estacionales y modelización de caudales de ríos del Brasil.'),
                        hr(),h4('Resume:'),
                        fluidRow(' '),
                        p('This paper deals with the application of the Cluster Analysis for Time Series
                        ...
                        p('Specifically what is done is to create a small number of clusters (from 2 to 4 clusters)
                        ...
                        p('We will show later the advantages and the efficiency of modeling a huge amount
                        ...
                        p('Thus we show that we managed to move from the problem of modeling 150 time 
                          series, to modeling the time series of a few clusters.'),
                        br(),
                        p(tags$b('Keywords:'),tags$i("Time Series Cluster Analysis, STL-Loess decomposition, Functional
           ...
           tabPanel('Clusters',
                    ...
                    fluidRow(
                      ...
                      sidebarPanel(
                        ...
                        p('Si desea puede seguir con el Análisis de Componentes Principales Funcional
                      ...
                      mainPanel(
                        ...
                        fluidRow(
                          dataTableOutput(outputId = "tabla_cluster")#, width = "50%")
                        ),hr(),
           ...
           tabPanel("ACP Funcional",
                    
                    h3(align="center","Análisis de Componentes Principales Funcional"),
                    
                    p('Primero realice el Análisis Clúster en la pestaña anterior (', 
                    ...
                    selectInput('n_clus_acpf2', label= 'Selecciona Clúster',selected = "1",
                                choices = 1:4
                    ),
                    
                    p("En el siguiente gráfico se muestran las series de Flujos que componene el clúster, 
                    ...
                    tabsetPanel(
                      ...
                      tabPanel("Gráfico",br(),br(),
                               dygraphOutput(outputId = "graf_vaz_clus2",width = "98%",height = "300px")
                    ...
                    p("A continuación, se muestra un conjunto de gráficos resultado de haber relizado el 
                      ACP Funcional de las series de Flujos del Cluster. Es decir, la función media del 
                      proceso, las funciones propias, y el porcentaje que aporta cada componente a la 
           ...
           tabPanel("SARIMAX",
                    ...
                    p("En esta sección modelaremos una serie de tiempo asociada a Flujos, usando como 
                      variables regresoras a variables Climáticas y las componentes principales del Clúster obtenidas
                    ...
                    selectInput('n_clus_acpf3', 
                                label= 'Selecciona Clúster',
                                selected = "1",
                                choices = 1:4
                    ),
                    p("A continuación, seleccione la estación correspondiente a la serie de tiempo de 
                      Flujos que desea modelar."),
                    #Seleccionar Estacion Vazoe
                    selectInput('nomb_est_vaz3', 
                    ...
                    p(tags$b("Nota:"),"Es posible que sea necesario desestacionalizar las series de clima, 
                      antes de ser usadas en el modelo."),
                    checkboxInput("ruidoClimaBox",label = "Desestacionalizar Series de Clima.",value = FALSE),
                    ...
                    tabsetPanel(
                      ...
                      tabPanel("Gráfico", br(),
                               p("Primero selecciona las variables de la tabla anterior para que sean graficadas."),
                    ...
                    tabsetPanel(
                      ...
                      tabPanel("Residuos",
                               br(),
                               p("A continuación podemos ver el gráfico de los residuos, su distribución, así como
